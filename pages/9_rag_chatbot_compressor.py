...
st.set_page_config(page_title="RAG Chatbot with Contextual Compression") #HTML title
st.title("RAG Chatbot with Contextual Compression") #page title
...
if input_text: #run the code in this if block after the user submits a chat message
    ...
    with st.chat_message("assistant"): #display a bot chat message
        ...
        chat_response = glib.get_rag_chat_with_contextual_compression_streaming_response(model_id=selected_model_id, input_text=input_text, memory=st.session_state.memory, index=st.session_state.vector_index,streaming_callback=st_callback) #call the model through the supporting library
